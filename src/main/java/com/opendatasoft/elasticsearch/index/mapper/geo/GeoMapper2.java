...
public class GeoMapper2 extends AbstractFieldMapper<Object>{
    ...
    public static class Builder extends AbstractFieldMapper.Builder<Builder, GeoMapper2> {
        ...
        public GeoMapper2 build(BuilderContext context) {
            ...
            return new GeoMapper2(names, prefixTree, strategyName, distanceErrorPct, wkbMapper, fieldDataSettings, docValues, fieldType, postingsProvider,
    ...
    public GeoMapper2(FieldMapper.Names names, SpatialPrefixTree tree, String defaultStrategyName, double distanceErrorPct, BinaryFieldMapper wkbMapper,
