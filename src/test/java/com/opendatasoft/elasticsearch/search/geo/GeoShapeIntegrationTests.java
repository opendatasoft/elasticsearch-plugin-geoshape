package com.opendatasoft.elasticsearch.search.geo;

import com.opendatasoft.elasticsearch.plugin.geo.GeoPlugin;
...
public class GeoShapeIntegrationTests extends ElasticsearchIntegrationTest {
    ...
    protected Settings nodeSettings(int nodeOrdinal) {
        ...
        return ImmutableSettings.builder().put("gateway.type", "local")
                .put("plugin.types", GeoPlugin.class.getName())
                .put(settings).build();
    }
    ...
    public void testShapeFetchingPath() throws Exception {
        createIndex("shapes");
        assertAcked(prepareCreate("test").addMapping("type", "location", "type=geo"));
     ...
     * @throws IOException
     */
    // FIXME : fix orientation persistence
    @Ignore
