...
`bin/plugin --install geoshape-plugin --url "https://github.com/opendatasoft/elasticsearch-plugin-geoshape/releases/download/v6.8.1.0/elasticsearch-plugin-geoshape-6.8.1.0.zip"`
