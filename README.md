...
`bin/plugin --install geoshape-plugin --url "https://github.com/opendatasoft/elasticsearch-plugin-geoshape/releases/download/v6.8.0.1/elasticsearch-plugin-geoshape-6.8.0.1.zip"`
...
| 6.8.0 | 6.8.0.1 | https://github.com/opendatasoft/elasticsearch-plugin-geoshape/releases/download/v6.8.0.1/elasticsearch-plugin-geoshape-6.8.0.1.zip |
