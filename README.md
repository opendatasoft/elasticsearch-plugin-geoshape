...
`bin/plugin --install geoshape-plugin --url "https://github.com/opendatasoft/elasticsearch-plugin-geoshape/releases/download/v7.1.0.1/elasticsearch-plugin-geoshape-7.1.0.1.zip"`
...
| 7.1.0 | 7.1.0.1 | https://github.com/opendatasoft/elasticsearch-plugin-geoshape/releases/download/v7.1.0.1/elasticsearch-plugin-geoshape-7.1.0.1.zip |
