...
`bin/plugin --install geoshape-plugin --url "https://github.com/opendatasoft/elasticsearch-plugin-geoshape/releases/download/v7.0.0.0/elasticsearch-plugin-geoshape-7.0.0.0.zip"`
...
| 7.0.0 | 7.0.0.0 | https://github.com/opendatasoft/elasticsearch-plugin-geoshape/releases/download/v7.0.0.0/elasticsearch-plugin-geoshape-7.0.0.0.zip |
